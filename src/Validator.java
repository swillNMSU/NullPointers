...
/**
 * This class validator is what was used to check the input from the user and
 * make sure
 * That the files that creat the Owner object have valid data. If the user ever
 * inputs
 * invalid data then these methods will repromp the user to renter input until
 * it is
 * valid.
 */
public class Validator {
     ...
     * 
     *         Precondition: The precondition for this method is that the parameter
     *         may be empty
     *         or not.
     * 
     *         Postcondition: The postcondition is that if the string is empty this
     *         method will
     *         return true. If the input is not empty then the method with return
     *         false
     * 
     *         This method responsabilty is to check if the users input is empty
     *         then it will return
     *         true, and if the input is not empty then it will return false. This
     *         method is a helper
     ...
     *         or not.
     * 
     *         Postcondition: If the number is negative it will return true, and if
     *         the number
     *         is positive then the method will return false.
     * 
     *         This method converts the user number input from a string to an
     *         integer. If the number
     *         is negative then it return true, and if the number is positive then
     ...
     * 
     *         Postcondition: This method returns true if the users name input is
     *         not valid. Other wise
     *         this method will return false if the user name input is correct.
     * 
     *         This method main purpose is to check the users input to see if the
     *         name is valid or not
     *         The first check is to see if the user entered an empty string if the
     *         string is empty the
     *         input is invalid. The next check is to see if the name has any
     *         invalid charcters. If the name
     *         has any other chacter that is not A-Z or a-z then it will set
     *         notvalid to false and get the
     *         index were it was not valid. If the name input was invalid then it
     *         will print the index were
     *         it was invalid and it will display a message to tell the user that
     *         the input was invalid and were.
     *         At this point method will be true. If the input is valid then it will
     *         return false.
     * 
     */
     ...
     *         returns a boolean true or false
     * 
     *         Precondition: This method is parameter is a string that could be
     *         empty or not
     * 
     *         Postcondition: This method returns true if the method is invalid or
     *         false if
     *         the input is valid.
     * 
     *         This method main purpose is to check if the string that the user
     *         input is empty or
     *         not if it is then return true for invalid input. The next check is in
     *         the for loop
     *         this checks to see if the string input is just number and not
     *         anything else, it also
     *         looks for the symbole - for negative numebrs. If the numebr had some
     *         other charater it
     *         reurns true. Else the string is converted to a number and if the
     *         number enter is greater
     ...
     * 
     *         Precondition: The string input from the parameter isValidStriked can
     *         be empty or not
     * 
     *         Postcondtion: The post condition for this method is that it return
     *         true if the date is
     *         invalid, and will return false if the data is valid.
     * 
     *         This method is used to check the strikes that each owner has gotten.
     *         The input is a string
     *         so we check to see if it is empty, if it is we return true, else
     *         false. The for loop goes
     *         through the input string and checks for the negative symbol or
     *         another character that is not
     *         a number. If it finds any of these it will return true. If none of
     *         these character are found and
     ...
     * @return
     *         This method return true for invalid input and also false for invalid
     *         input
     * 
     *         Precondition: The string parameter might be empty or it may be valid
     *         Postcondition: This method returns true if the data is invalid, and
     *         false if the data
     *         is valid.
     * 
     *         The first check in this method is to see if the string input is empty
     *         if it is return true.
     *         The next check is to go through the string input and check for a -
     *         sign and also make sure that
     *         the input does not have an invalid charcter any where in the input.
     *         If all of the charcter dont mess up
     *         then the next step is to convert the string into a number. Then we
     *         check the number to make sure that
    ...
    public boolean checkNumPets(String isValidNumPets) {
        ...
        // We should allow zero pets. Just because someone doesn't qualify it doesn't
        // mean they shouldn't be in the records.
     ...
     * 
     *         Precondition: This method precondition is that the parameter might be
     *         empty or it
     *         might have characters in the string.
     * 
     *         Postcondition: Returns true for invalid data and false for valid
     *         data.
     * 
     *         This methods main purpose is tp check the address input strign from
     *         the user. If the input
     *         is empty return true. The for loop in this method checks to see if
     *         the characters in the string
     *         are valid. If they are not valid then this method will return true,
     *         else it will return false for valid input.
     */
